...
define([
    ...
    'backbone',
    'collections/Hateoas',
    'text!templates/news/newspage7.html'
    ...
    var NewsOneView = Backbone.View.extend({
        ...
        initialize: function () {
            ...
            category1.url = "data-rest/category/search/findOneWithCatName?categoryName=cat7";
            ...
            collection0.url = "data-rest/news/search/findByCategoryName?categoryName=cat7&lang="+language;
