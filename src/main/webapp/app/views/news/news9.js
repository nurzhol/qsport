...
define([
    ...
    'backbone',
    'collections/Hateoas',
    'text!templates/news/newspage9.html'
    ...
    var NewsOneView = Backbone.View.extend({
        ...
        initialize: function () {
            ...
            category1.url = "data-rest/category/search/findOneWithCatName?categoryName=cat9";
            ...
            collection0.url = "data-rest/news/search/findByCategoryName?categoryName=cat9&lang="+language;
