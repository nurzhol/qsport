...
define([
    ...
    'backbone',
    'collections/Hateoas',
    'text!templates/news/newspage19.html'
    ...
    var NewsOneView = Backbone.View.extend({
        ...
        initialize: function () {
            ...
            collection0.url = "data-rest/news/search/findByCategoryNameByPage?categoryName=cat19&lang="+language;
        ...
        render: function () {
            ...
            category1.url = "data-rest/category/search/findOneWithCatName?categoryName=cat19";
