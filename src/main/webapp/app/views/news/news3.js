...
define([
    ...
    'backbone',
    'collections/Hateoas',
    'text!templates/news/newspage3.html'
    ...
    var NewsOneView = Backbone.View.extend({
        ...
        initialize: function () {
            ...
            collection0.url = "data-rest/news/search/findByCategoryBatchByPage?lang="+language;
        ...
        render: function () {
            ...
            category1.url = "data-rest/category/search/findOneWithCatName?categoryName=cat3";
