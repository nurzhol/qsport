...
define([
    ...
    'backbone',
    'collections/Hateoas',
    'text!templates/news/newspage4.html'
    ...
    var NewsOneView = Backbone.View.extend({
        ...
        initialize: function () {
            ...
            collection0.limit = 50;
            this.model = collection0;

            collection0.url = "data-rest/news/search/findByCategoryNameByPage?categoryName=cat4&lang="+language;
        ...
        render: function () {
            ...
            category1.url = "data-rest/category/search/findOneWithCatName?categoryName=cat4";
