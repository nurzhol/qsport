...
define([
    ...
    'backbone',
    'collections/Hateoas',
    'text!templates/news/newspage16.html'
    ...
    var NewsOneView = Backbone.View.extend({
        ...
        initialize: function () {
            ...
            collection0.limit = 30;
            this.model = collection0;

            collection0.url = "data-rest/news/search/findByCategoryNameByPage?categoryName=cat16&lang="+language;
