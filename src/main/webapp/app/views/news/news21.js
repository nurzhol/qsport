...
define([
    ...
    'backbone',
    'collections/Hateoas',
    'text!templates/news/newspage21.html'
    ...
    var NewsOneView = Backbone.View.extend({
        ...
        initialize: function () {
            ...
            category1.url = "data-rest/category/search/findOneWithCatName?categoryName=cat21";
            ...
            collection0.url = "data-rest/news/search/findByCategoryName?categoryName=cat21&lang="+language;
