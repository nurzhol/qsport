...
define([
    ...
    var NewsOneView = Backbone.View.extend({
        ...
        initialize: function () {
            ...
            collection0.limit = 10;
            this.model = collection0;

            collection0.url = "data-rest/news/search/findByCategoryNameByPage?categoryName="+this.catnum+"&lang="+language;
        ...
        render: function () {
            ...
            category1.url = "data-rest/category/search/findOneWithCatName?categoryName="+this.catnum;
