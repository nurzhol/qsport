...
define([
    ...
    var NewsOneView = Backbone.View.extend({
        ...
        initialize: function () {
            ...
            category1.url = "data-rest/category/search/findOneWithCatName?categoryName=cat23";
            ...
            collection0.url = "data-rest/news/search/findByCategoryName?categoryName=cat23&lang="+language;
