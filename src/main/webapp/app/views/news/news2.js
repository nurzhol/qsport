...
define([
    ...
    var NewsOneView = Backbone.View.extend({
        ...
        initialize: function () {
            ...
            collection0.url = "data-rest/news/search/findByCategoryName?categoryName=cat2&lang="+language;

            collection0.fetch().done(function(){
                $(self.el).html(self.template({translite: translite, categoryName:"Таңдаулы тақырып" ,
