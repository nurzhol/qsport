...
(function ($, window) {
			...
			return this.each(function () {
				...
				if (!data) { //check if event is already assigned
					...
					$(obj).bind('click.YouTubePopup', function () {
						...
						YouTubeURL += "&showinfo=" + options.showinfo + "&color=" + options.color + "&theme=" + options.theme +"&start=" + options.start;
    ...
    $.fn.getYouTubeVideoDuration = function(id){
       ...
       var result =  $.ajax({
        ...
        return resultObj.entry.media$group.yt$duration.seconds;
    }


    $.fn.toHHMMSS = function (sec) {
